...
ggplot(ComparisonlifeExp) + geom_line(aes(x=year, y=lifeExp, color=country)) + ylab("Life Expectancy") + ggtitle("Comparison of Life Expectancy in Caribbean Nations to World Average")
...
#notworking
#ggplot(gm_5countries, aes(x=year, y=lifeExp, color=country)) + geom_line() +
#  geom_line() + ylab("Life Expectancy") +
#  ggtitle("Life Expectancy in Caribbean compared to world wide median")
